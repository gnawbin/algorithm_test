...
#ifndef GENERALIZED_INVERSE_MATRIX_OF_SINGULAR_MATRIX_H
#define GENERALIZED_INVERSE_MATRIX_OF_SINGULAR_MATRIX_H
#include <cmath>
#include <iostream>
...
{
    int i,j,k,l,t,p,q,f;
    i=singular_value_decomposition(a,m,n,u,v,eps,ka);
    if (i<0) return(-1);
    j=n;
    if (m<n) j=m;
    j=j-1;
...
#endif //GENERALIZED_INVERSE_MATRIX_OF_SINGULAR_MATRIX_H
